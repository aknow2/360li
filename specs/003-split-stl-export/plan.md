...
Stand and shell-to-stand transition tetrahedra are not assigned wholesale to the southern row. For the requested `vMin/vMax`, each original stand vertex `p=(x,y,z)` receives the two homogeneous cone scalars:
